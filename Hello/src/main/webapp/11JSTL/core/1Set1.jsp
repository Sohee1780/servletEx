...
<body>
	<!-- 
		...
		JSP의 표준 태그 라이브러리를 이용하면 스크립틀릿을 사용하지 않고 태그를  사용하여
		제어문, 반복문등을 사용 할 수 있습니다.
		
		기본태그가 아닌 확장태그이므로 사용하기 위해서는 별도의 라이브러리가 필요
		메이븐리파지토리로 접근하여 jstl-1.2.jar파일을 다운로드받고 lib폴더에 추가합니다.
	...
	<!-- scope를 지정하지 않으면 페이지부터 순서대로 찾아감 -->
	<ul>
		<li>${personVal1.id }</li>
