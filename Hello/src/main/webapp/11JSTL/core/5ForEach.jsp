...
<h4>일반 for문 형태의 forEach문</h4>
	...
	<!-- 
	varSatus 루프의 현재 상태를 알려주는 변수 이름
	...
	<%
		...
		map.put("1st",new Member("1st","","name5",""));
		map.put("2nd",new Member("2nd","","name6",""));
		map.put("3rd",new Member("3rd","","name7",""));
	%>
	...
	<!-- 
		Token : 문법적으로 의미 있는 최소단위
				구분자를 기준으로 문자열을 나눠 토큰의 개수만큼 반복합니다.
		items : 문자열(문자열만 사용가능)
		delims : 구분자
		var : 변수명
	-->
