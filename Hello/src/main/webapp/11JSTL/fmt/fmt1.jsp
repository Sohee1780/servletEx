...
<body>
	...
	<fmt:formatNumber value="${num }" pattern="0,00.0"/><br>
	<fmt:formatNumber value="${num }" pattern="0,000,00.0"/><br>
	<fmt:formatNumber value="${num }" pattern="#,###.##"/><br>
	<fmt:formatNumber value="${num }" pattern="###,###.0000000"/><br>
	
	<fmt:parseNumber value="${num }" integerOnly="true" var="saveVar"/>
	정수 부분만 : ${saveVar }
